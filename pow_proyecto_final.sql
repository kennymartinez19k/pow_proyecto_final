...
-- Tiempo de generación: 15-07-2022 a las 12:18:16
...
--
-- Base de datos: `pow_proyecto_final`
--
...
INSERT INTO `contacto` (`id`, `nombre`, `email`, `fecha`, `asunto`, `comentario`) VALUES
(1, 'juan', 'a@j.com', '2021-01-01', 'tienda', ' tineda 2'),
(3300, '13', 'juan@gmail.com', '0123-03-12', '123', '123'),
(39209, 'tienda juan', 'juan@gmail.com', '2022-07-28', 'tienda', 'la mejor tienda del pais'),
(57144, 'Arelis store', 'arelis@gm.com', '2022-07-20', 'Tienda de ropa', 'Tienda de ropa y mas');
...
--
ALTER TABLE `contacto`
  MODIFY `id` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57145;
COMMIT;
